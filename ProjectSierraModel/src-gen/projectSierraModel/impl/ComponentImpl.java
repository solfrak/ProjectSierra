 ...
 * </p>
 * <ul>
 *   <li>{@link projectSierraModel.impl.ComponentImpl#getPerforms <em>Performs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentImpl extends ContainableElementImpl implements Component {
	/**
	...
	protected EClass eStaticClass() {
		return ProjectSierraModelPackage.Literals.COMPONENT;
	}
	...
	public EList<Function> getPerforms() {
		if (performs == null) {
			performs = new EObjectWithInverseResolvingEList.ManyInverse<Function>(Function.class, this,
					ProjectSierraModelPackage.COMPONENT__PERFORMS, ProjectSierraModelPackage.FUNCTION__IS_PERFORMED_BY);
		}
		return performs;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ProjectSierraModelPackage.COMPONENT__PERFORMS:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == PerformingElement.class) {
			...
			case ProjectSierraModelPackage.PERFORMING_ELEMENT__PERFORMS:
				return ProjectSierraModelPackage.COMPONENT__PERFORMS;
			default:
				return -1;
			}
		}
