...
/**
 * This is the item provider adapter for a {@link projectSierraModel.ActivityDiagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityDiagramItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(ProjectSierraModelPackage.Literals.ACTIVITY_DIAGRAM__CONTAINABLE_ELEMENTS,
						ProjectSierraModelFactory.eINSTANCE.createExchange()));

		newChildDescriptors
				.add(createChildParameter(ProjectSierraModelPackage.Literals.ACTIVITY_DIAGRAM__CONTAINABLE_ELEMENTS,
						ProjectSierraModelFactory.eINSTANCE.createChain()));

		newChildDescriptors
				.add(createChildParameter(ProjectSierraModelPackage.Literals.ACTIVITY_DIAGRAM__SPECIALIZABLE_ELEMENTS,
						ProjectSierraModelFactory.eINSTANCE.createCapabilitty()));

		newChildDescriptors
				.add(createChildParameter(ProjectSierraModelPackage.Literals.ACTIVITY_DIAGRAM__SPECIALIZABLE_ELEMENTS,
						ProjectSierraModelFactory.eINSTANCE.createActor()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == ProjectSierraModelPackage.Literals.ACTIVITY_DIAGRAM__SPECIALIZABLE_ELEMENTS
				|| childFeature == ProjectSierraModelPackage.Literals.ACTIVITY_DIAGRAM__PERFORMING_ELEMENTS;
